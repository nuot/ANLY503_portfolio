...
as a add-on part of any real estate price predicion tasks.Data used: Zillow Prize: Zillow’s Home Value Prediction (Zestimate) and
NYC Property Sales
...
### I also curious which counties have most family dwellings. From the nexwork plot, it shows that 'ozone park' are mostly close to the center '01 one family dwellings', which means that county has the most family dwellings comparing to other county.
